...
class QuestionsDataTable extends DataTable
{
     ...
     * @return Builder
     */
    public function query(Questions $model): Builder
    {
    ...
    protected function getColumns(): array
    {
        return [
            ...
            Column::make('question')->title('Pregunta')->className('text-center'),
            Column::make('answer')->title('Respuesta')->className('text-center'),
    ...
    public function dataTable($query): DataTableAbstract
    {
        ...
        return datatables()
            ...
            ->editColumn('question', static function ($query) {
                return $query->question;
            })
            ->editColumn('answer', static function ($query) {
                return $query->answer;
            })
