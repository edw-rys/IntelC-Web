...
class AccomodationDataTable extends DataTable
{
    use DataTableBase;

    private $action = 'accommodation';
    private $route  = 'admin.accommodation';
    public $filters;
     ...
     * @return Builder
     */
    public function query(Accommodation $model): Builder
    {
    ...
    protected function getColumns(): array
    {
        return [
            ...
            Column::make('phone')->title('Teléfono')->className('text-center'),
            Column::make('address')->title('Dirección')->className('text-center'),
